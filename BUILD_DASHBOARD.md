...
A single `<h1 class="dash-title">michael dashboard</h1>` at the very top of the body. Styled as:
...
- The page opens with a gradient `michael dashboard` headline at the top.
